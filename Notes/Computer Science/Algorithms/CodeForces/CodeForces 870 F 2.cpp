...
*/
	...
	for(b=0;b<a;b++){
		in>>ad>>bd;
		for(auto dudex:avd){
			if(abs(dudex-ad)<0.001){
				dvd[2*b]=dudex;
				dvd[2*b+1]=(bd-dudex/10000)*(10000*10000+1);
			}
		}
	}
	out<<"!";
