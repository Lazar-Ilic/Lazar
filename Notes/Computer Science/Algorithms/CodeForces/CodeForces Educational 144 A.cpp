...
Z az(){
	...
	*/
	...
	if(sz(lol)==0)lol="FBFFBFFBFBFFBFFBFBFFBFFB";
	in>>a>>as;
	for(b=a-1;b<sz(lol);b++)if(as==lol.substr(b-(a-1),a)){out<<"YES"<<nl;return;} // Can do a simpler string contain check with a canonical strings processing algorithm in O[34=24+10] time. But this code is much easier and simpler to write up and AC in round.
	out<<"NO"<<nl;
}
