...
/*
Monovariant here is like sum of even dudes - sum of odd dudes I think and so like WLOG we can simply uh do it in O[n] hunting for set everything to 0 except the uh final dude is like uh if and only if sum of that dude is >=
*/
