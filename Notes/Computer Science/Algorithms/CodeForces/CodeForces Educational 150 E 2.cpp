...
*/
	...
	in>>a;
	cv=V(a+1,0); // Multiplicity for each horizontal dude uh.
	av=V(a);
	for(b=0;b<a;b++)in>>av[b]; // Heights hanging down uh. Alternately uh invert and think of stalagmites I mean standing up towers uh and inversion uh... split split split uh start from the bottom uh. Ah eh think from other way up is better uh uh uh split split split uh. Process rectangles from bottom to top uh... perhaps there is a super duper simple recursive uh functional implementation here ugh.
}
