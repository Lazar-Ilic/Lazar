...
/*
Well it seems to me like we can umm simply uh is it as easy as taking the uh in out order and removing uh umm... I know we can safely maybe consider doing like a parity argumentation in the Breadth First Search distance and uh clear out bottom leaf nodes and 2nd from bottom layer uh trivially I think uh and recurse upwards Bottoms Up Tree Dynamic Programming etc. something about parity and the Breadth First Search uh Depth First Search in out orer and skipping later instances of uh nodes I mean basically uh skipping the even uh levels as needed in an ordering uh. OKOKOK well then maybe I uh need to examine those levels and multiplicities more closely uh I think maybe it is a theorem that uh binary trees work but also uh a 1-5 tree works e.g. a 1-n tree and thus there is no super duper wooper simple criterion here to determine for me if it can or can not be done.
*/
