	...
	for(b=a-1;b>=0;b--){
		for(auto dude:levels[b]){
			if(sz(children[dude])>0){
				if(as[dude]=='U'){
					av[dude]=1+av[children[dude][0]];
					if(sz(children[dude])>1 and 1+av[children[dude][1]]<av[dude])av[dude]=1+av[children[dude][1]];
				}
				else if(as[dude]=='L'){
					if(avp[dude].first!=-1){
						av[dude]=av[avp[dude].first];
						if(avp[dude].second!=-1 and 1+av[avp[dude].second]<av[dude])av[dude]=1+av[avp[dude].second];
					}
					else{
						av[dude]=1+av[avp[dude].second];
					}
				}
				else if(as[dude]=='R'){
					if(avp[dude].second!=-1){
						av[dude]=av[avp[dude].second];
						if(avp[dude].first!=-1 and 1+av[avp[dude].first]<av[dude])av[dude]=1+av[avp[dude].first];
					}
					else{
						av[dude]=1+av[avp[dude].first];
					}
				}
			}
		}
