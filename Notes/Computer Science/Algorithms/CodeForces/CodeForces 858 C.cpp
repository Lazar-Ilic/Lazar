...
Z az(){
	...
	/*
	Ugh not really interested in feeling like doing this task here today seems uh probably like some trivial Algebra onsight some Arithmetic Mean Geometric Mean smoothing style whatever maybe not in the mood would have rather onsighted cracked F2 here today for the Master rating I suppose but that is what it is that is life and I gotta focus on taking ~0 epsilon penalty in the future because penalty is such a biotch.
	*/
