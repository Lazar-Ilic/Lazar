...
Z az(){
	...
	/*
	Chain umm. Powers of 2 um. And then um like... OKOKOK so obviously l,2l,4l,... works but then like... oh gee I mean we can not have a 4 obviously and I think even 3 3 is banned too so like all 2s works or all 2s and 1 3 um hop in.

4 8 16 32 64... 16 or uh 24
4 5 6 ah 1
	*/
	...
	out<<z+1<<" ";
	al=b/(1<<z)-a+1;
	if(L(a)*(1<<z)*3/2<=b)al+=L(z)*(b/((1<<z)*3/2)-a+1);
	out<<al%p<<nl;
}
