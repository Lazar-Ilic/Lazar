...
Analysis:
There must be <=k-1 people as close as him or closer. Means that uh the uh range we can sort I think fast and then uh the range basically from the 1st to k-1st person is like uh... can maybe 2 pointers and uh... consider the uh median from the range or uh... maybe gap out uh k+1 gap so we must be closer than the dude on the Left and Right and uh 2 pointers and then uh... sort and uh intervals works I think to produce the uh... values here but not too sure not too sure and uh time feels like it is slipping away here frankly 6 minutes in to the round not too too too sure. Not in the mood here really ugh think maybe sticking to Educational until hitting 2100 is sharper anyways ugh on Simple Statistics argumentation.
*/
