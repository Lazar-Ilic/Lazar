...
All about the salary
And all about reality
Zen Clique Up
Motivated decision
Process Trading Driven
Multiplication and division
Monkey Gorila Tiger GOAT
LASER is the Truth
...
*/
	...
	in>>n>>ac>>as;
	bs="";
	for(c=0;c<sz(as) and sz(bs)==0;c++){
		if(as[c]<ac or (as[c]==ac and c<sz(as)-1 and as[c+1]<ac))bs=as.substr(0,c)+ac+as.substr(c,sz(as)-c);
	}
	if(sz(bs)==0)out<<as+ac<<nl;
	else out<<bs<<nl;
}
