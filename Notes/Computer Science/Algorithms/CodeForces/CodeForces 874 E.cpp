...
/*
Analysis:
So there are some edges and forced cycles but I think the remaining noncompleted cycles can either convert in to 1 or the actual number of separate dudes.
...
*/
	...
	z=0; // Completed cycles.
	y=0; // Incompleyed cycles.
	avb=VB(a,0);
	for(b=0;b<a;b++){
		if(avb[b]==0){
			// Process.
