...
https://codegolf.stackexchange.com/questions/248259/permutations-summing-to-permutations

Can pair off I think with respect to the underlying summation to n+1 for example probably works here like 0 5 2 3 4 1 6 7 mmm like? 2 7 4 5 7 8 1?

8 1 6 3 4 5 2 7

https://oeis.org/A141599
*/
	...
	for(b=0;b<a/2;b++)out<<a-2*b<<" "<<2*b+1<<" ";
	out<<nl;
}
