...
Z az(){
	...
	*/
	in>>a>>as;
	b=0;
	while(b<a and as[b]=='M' or as[b]=='m')b++;
	c=b;
	while(b<a and as[b]=='E' or as[b]=='e')b++;
	d=b;
	while(b<a and as[b]=='O' or as[b]=='o')b++;
	e=b;
	while(b<a and as[b]=='W' or as[b]=='w')b++;
	f=b;
	if(b==a and c>0 and d>c and e>d and f>e)out<<"YES"<<nl;
	else out<<"NO"<<nl;
}
