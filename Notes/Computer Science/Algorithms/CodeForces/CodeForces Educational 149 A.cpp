...
/*
Analysis:
Sum is 0 implies partitionable. Think then we can do it with 2 colours uh... just need uh to capture some point where there are X (s to Left and X )s to Right is swoop swoop and the reverse is uh Y )s to Left and Y (s to Right.

Post Contest Analysis:
Oops leaked the actionable information Task D Tutorial mid-round to my room should hopefully never happen again or else I think this is potentially an actionable foul worth being penalised or Black listed from CodeForces platform system for so I oughta gotta ensure to scrape all notes upon other tasks from my template mid-round.
