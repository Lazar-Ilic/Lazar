...
/*
Interesting enough uh task statement I guess suggests some kind of a uh symmetry might be induced in the uh Type Of Query 1 but not too sure really need to focus in here.
...
So uh is there some simple way to alternate Type 1 and Type 2 queries or is there a super duper simple way to chain off some precomputed set of Type 1 queries like n of them followed up by uh n-2 say Type 2 queries to then deduce the uh answer up to symmetry?

Does the simplest set of the following kind simply work uh ugh Type 1 queries on 2, 4, 6, 8, ..., 2n followed up with like uh something else uh.
*/
	...
	if(a%2==0 and al>=bl)out<<"YES"<<nl;
	else if(a%2==0)out<<"NO"<<nl;
	else if(bl>=al)out<<"YES"<<nl;
	else out<<"NO"<<nl;
}
