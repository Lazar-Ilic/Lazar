...
Z az(){
	...
	/*
	Something about the underlying graph of auxiliaries umm generating like a spanning set on the underlying Strongly Connected Components I think ugh umm.
	*/
