...
*/
	...
	z=0;
	for(c=0;c<b and !z;c++)for(d=0;d<a and !z;d++)if(avs[d][c]=='v')z=1;
	if(z)z=0;
	else{
		out<<"NO"<<nl;
		return;
	}
	for(;c<b and !z;c++)for(d=0;d<a and !z;d++)if(avs[d][c]=='i')z=1;
	if(z)z=0;
	else{
		out<<"NO"<<nl;
		return;
	}
	for(;c<b and !z;c++)for(d=0;d<a and !z;d++)if(avs[d][c]=='k')z=1;
	if(z)z=0;
	else{
		out<<"NO"<<nl;
		return;
	}
	for(;c<b and !z;c++)for(d=0;d<a and !z;d++)if(avs[d][c]=='a')z=1;
	if(z)out<<"YES"<<nl;
	else out<<"NO"<<nl;
}
