...
Z az(){
	...
	in>>a>>b>>c;
	// DO RE MI again...
	// Kind of reminds me of that AtCoder Beginner Contest 279 Task E which just took place earlier this morning round like maybe we can somehow process through with some kind of a range query kind of structure update do the usual 2 times through trickerino and then update through some graph digraph flow sort of a structure for the number of unique distinct values type query.
}
