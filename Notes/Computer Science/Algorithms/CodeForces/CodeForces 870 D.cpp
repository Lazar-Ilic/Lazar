...
/*
Case over uh middle values I guess and then uh extract out the uh like uh most valuable dude to the uh right and left using 2 uh like off dudes ugh. Ugh misread on the uh long long condition there in round should not Time Limit Exceeded but ugh.
*/
	...
	m=0;
	for(b=1;b<a-1;b++)m=max(m,av[b]+bv[b]+cv[b]);
	out<<m<<nl;
}
