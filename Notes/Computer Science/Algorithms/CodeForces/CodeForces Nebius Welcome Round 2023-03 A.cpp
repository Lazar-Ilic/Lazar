...
Z az(){
	...
	In any case this task I think is as trivial as computing the dominating direction and then uh we can greedy ABABABABAB[A][-A-A-A] until ending from there.
	*/
