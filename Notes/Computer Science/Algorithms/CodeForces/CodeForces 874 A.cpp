...
/*
Dedicated to Kevin Tian and Christopher Martin and Josephine Vander Gucht and all of the brothers out there... ~9 years anniversary of Ghost Stories Coldlay...
...
*/
	...
	in>>a>>as;
	for(b=0;b<a-1;b++)aset.insert(26*(as[b]-'a')+(as[b+1]-'a'));
	out<<sz(aset)<<nl;
}
