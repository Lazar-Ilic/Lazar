...
Z az(){
	...
	/*
	Canonical intervals handling task one would suppose that it suffices to find the earliest ending Time for a dude and then smack down a pack Right then starting at that time to then interval hit and process through basically the dude's intervals sorted by uh both and Left and Right point simultaneously maybe with an underlying reference vector on index and uh processed Vector Of Booleans approach out to work here like Something Just Like This smash it out I dunno.
	*/
