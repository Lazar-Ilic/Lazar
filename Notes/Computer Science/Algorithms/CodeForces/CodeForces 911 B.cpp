...
*/
	...
	in>>a>>b>>c;
	if(a%2==b%2 and b%2==c%2)out<<"1 1 1"<<nl;
	else if(a%2!=b%2 and a%2!=c%2)out<<"1 0 0"<<nl;
	else if(b%2!=a%2 and b%2!=c%2)out<<"0 1 0"<<nl;
	else if(c%2!=a%2 and c%2!=b%2)out<<"0 0 1"<<nl;
}
