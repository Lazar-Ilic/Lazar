...
Analysis:
Interesting enough task here for task E is like uh... if we could identify 2 4s somehow early on or like 2 1s maybe or uh... somehow deduce Pigeonhole the location of like a couple representatives uh... immediately note that like if they were all 1s except for 1 other dude then we would not be able to deduce that other dude uh...
*/
