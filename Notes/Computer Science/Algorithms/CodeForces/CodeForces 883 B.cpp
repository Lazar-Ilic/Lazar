...
*/
	...
	in>>as>>bs>>cs;
	if(as[0]!='.' and as[0]==as[1] and as[0]==as[2])out<<as[0]<<nl;
	else if(bs[0]!='.' and bs[0]==bs[1] and bs[0]==bs[2])out<<bs[0]<<nl;
	else if(cs[0]!='.' and cs[0]==cs[1] and cs[0]==cs[2])out<<cs[0]<<nl;
	else if(as[0]!='.' and as[0]==bs[0] and as[0]==cs[0])out<<as[0]<<nl;
	else if(as[1]!='.' and as[1]==bs[1] and as[1]==cs[1])out<<as[1]<<nl;
	else if(as[2]!='.' and as[2]==bs[2] and as[2]==cs[2])out<<as[2]<<nl;
	else if(as[0]!='.' and as[0]==bs[1] and as[0]==cs[2])out<<as[0]<<nl;
	else if(as[2]!='.' and as[2]==bs[1] and as[2]==cs[0])out<<as[2]<<nl;
	else out<<"DRAW"<<nl;
}
