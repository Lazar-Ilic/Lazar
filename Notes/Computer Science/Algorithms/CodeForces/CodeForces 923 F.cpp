...
*/
	...
	in>>a>>b;
	// I am too lazy now ugh I should really be more trained and ready to go with codes like this one for competition settings ugh... just find the minimum edge which is not a bridge... and then can cyle bash from there by doing removing that edge and Breadth First Searching quite simply from one of those dudes ugh...
}
