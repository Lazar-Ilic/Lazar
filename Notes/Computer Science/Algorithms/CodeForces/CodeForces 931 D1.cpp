...
*/
	...
	in>>al>>bl;
	if((al bx bl)<al and (al bx bl)>0){
		out<<1<<nl;
		out<<al<<" "<<bl<<nl;
		return;
	}
	y=62;
	while((((L)1<<y) ba al)==(((L)1<<y) ba bl)){
		y--;
	}
	y--;
	while((((((L)1<<y) ba al))==0 and ((((L)1<<y) ba bl))==0) or (((((L)1<<y) ba al))>0 and ((((L)1<<y) ba bl))==0)){
		if((((((L)1<<y) ba al))>0 and ((((L)1<<y) ba bl))==0)){
			out<<2<<nl;
			out<<al<<" "<<((al-((L)1<<y)) bo (((L)1<<y)-1))<<" "<<bl<<nl;
			return;
		}
		y--;
	}
