...
*/
	...
	for(d=0;d<3;d++){
		for(b=0;b<a;b++){
			in>>c;
			if(c>=avvv[d][0][0]){
				avvv[d][2][0]=avvv[d][1][0];
				avvv[d][2][1]=avvv[d][1][1];
				avvv[d][1][0]=avvv[d][0][0];
				avvv[d][1][1]=avvv[d][0][1];
				avvv[d][0][0]=c;
				avvv[d][0][1]=b;
			}
			else if(c>=avvv[d][1][0]){
				avvv[d][2][0]=avvv[d][1][0];
				avvv[d][2][1]=avvv[d][1][1];
				avvv[d][1][0]=c;
				avvv[d][1][1]=b;
			}
			else if(c>=avvv[d][2][0]){
				avvv[d][2][0]=c;
				avvv[d][2][1]=b;
			}
		}
	...
	for(d=0;d<3;d++){
		for(e=0;e<3;e++){
			for(f=0;f<3;f++){
				if(avvv[0][d][1]!=avvv[1][e][1] and avvv[1][e][1]!=avvv[2][f][1] and avvv[2][f][1]!=avvv[0][d][1] and avvv[0][d][0]+avvv[1][e][0]+avvv[2][f][0]>m)m=avvv[0][d][0]+avvv[1][e][0]+avvv[2][f][0];
			}
		}
	}
	out<<m<<nl;
