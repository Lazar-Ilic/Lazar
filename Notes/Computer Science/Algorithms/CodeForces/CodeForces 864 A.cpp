...
*/
	...
	in>>a>>b>>c>>d>>e>>f;
	if((c==1 and d==1) or (c==1 and d==b) or (c==a and d==1) or (c==a and d==b) or (e==1 and f==1) or (e==1 and f==b) or (e==a and f==1) or (e==a and f==b))out<<2<<nl;
	else if((c==1) or (d==1) or (c==a) or (d==b) or (e==1) or (f==1) or (e==a) or (f==b))out<<3<<nl;
	else out<<4<<nl;
}
