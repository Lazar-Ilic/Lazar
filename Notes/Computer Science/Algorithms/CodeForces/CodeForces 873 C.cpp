...
I need to work or train more on onsighting pointers O[log n] multiplicative runtime factor reductions in round more... this habit of composing terse mediocre Competitive Programming codes has to end soon if I want to snag Hudson River Trading.
...
*/
	...
	sortify(bv);
	al=1;
	for(c=a-1;c>=0;c--)al=(al*(av.end()-lowerbound(av.begin(),av.end(),bv[c]+1)-(a-1-c)))%p;
	out<<al<<nl;
}
