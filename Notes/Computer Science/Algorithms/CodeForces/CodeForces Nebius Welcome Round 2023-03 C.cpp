...
Z az(){
	...
	/*
	Seems like a simple enough trivial equation something something yadda yadda triangular numbers modulo yadda yadda blah blah and residude classes upon the underlying n at which point you would think that O[n] works on the actual uh underlying or perhaps it is like something simple in terms of the given p and necessary potential values inside of the residues modulo 2n or whatever.
	*/
