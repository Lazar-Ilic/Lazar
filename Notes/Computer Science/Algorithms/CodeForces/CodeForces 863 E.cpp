...
/*
Is like computing the desired number in base 9 and then converting back where a digit that is >=4 gets shifted up 1.
*/

	in>>al;
	while(al!=0){av.add((al%9)+(al%9>=4));al/=9;}
	reverse(all(av));
