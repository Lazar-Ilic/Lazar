...
Z az(){
	...
	/*
	Simply appending the binary representations of like the first coordinate and the second coordinate should work as they all cancel out into a 0 evaluation for each such uh 2x2 submatrix and have distinct values.
	*/
