...
/*
OK uh so the difference between consecutive terms is like uh...

a choose k - a-1 choose k is umm. a-1 choose k-1 I guess.

Certainly I do know how to uh generate all potentially useful uh coefficients in the binomials in O[n] as the only relevant dudes are in the uh first 5 diagonals at most is like equivalent with uh 5 rows. I mean O[5n] there.

OKOKOK but the uh formula actually helps us here. In particular to get from 1 value to the next we uh just need uh like to add previous dude uh all times uh x and then add in y times uh the sum of the uh coefficients her and then uh add in the relvatn term. OK
*/
