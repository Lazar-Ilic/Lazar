...
/*
Umm so d is pretty small umm... so 1 is like a uh cyclic shift of uh the other umm... polynomial means umm... well umm... how does this break down umm with respect to umm the power and the uh set of potential umm values umm... OKOKOK degree d is like umm d roots umm I mean umm... consider umm... reducing the ummm OKOKOK consider these uh values umm... modulo umm like modulo umm... p is like... OKOKOK so I think that uh s divids uh like B[x]=A[x+s] is like uh... B[x]-A[x] is like uh... A[x+s]-A[s] is like uh s divides uh all of the uh deltas I tihnk uh... GCD works?

OKOKOK so let us rigourously analyse this... mod mod mod and uh divisors umm umm... divisors is not AC here I think because actually umm we could have the underlying be like ummm... some delta here in the constant ter umm a0 can emerge in the ring from like a uh ummm any sort of a uh Delta+a*p term so it is not even nearly that trivial here umm...
*/
