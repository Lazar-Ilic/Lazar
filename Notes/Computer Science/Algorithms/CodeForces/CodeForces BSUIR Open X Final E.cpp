...
Z az(){
	...
	/*
	Immediately would suggest that like a Breadth First Search strategy here cased upon the locations of both the cat and the dog works in O[n^2 * m^2] for those possible position pairs.
	*/
