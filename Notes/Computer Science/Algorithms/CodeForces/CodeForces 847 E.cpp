...
/*
Rearranges to like x+n and x-n need to XOR to x I think. Ugh think about the binary string now... 10 works ugh 101 does not work ugh... 1010 works ugh... 110 does not work ugh 10010 and 100100 OKOKOK I think as long as it is singletons we can simply add in te ugh 10010 is XOR of 11011 and 01001 which I think is right... 9 and 27...
*/
	in>>a;
	av=V(32,0);
	for(b=31;b>=0;b--){
	...
	// Converted into binary string.
	if(av[31]==1){
		out<<-1<<nl;
		return;
	}
	for(b=31;b>=1;b--){
		if(av[b]==1 and av[b-1]==1){
			out<<-1<<nl;
			return;
		}
	}
