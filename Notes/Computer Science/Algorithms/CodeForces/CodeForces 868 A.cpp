...
/*
"You Are the Same Decaying Organic Matter As Everything Else." - Fight Club

"You are not special. You're not a beautiful and unique snowflake. You're the same decaying organic matter as everything else. We're all part of the same compost heap. We're all singing, all dancing crap of the world."

I am not special. I am not a beautiful and unique snow flake. I am the same decaying organic matter as everything else. I am part of the same compost heap.
*/

	in>>a>>b;
	for(c=0;c<=a/2;c++){
		if(c*(c-1)/2+(a-c)*(a-c-1)/2==b){
			out<<"YES"<<nl;
			for(d=0;d<c;d++)out<<-1<<" ";
			for(d=0;d<a-c;d++)out<<1<<" ";
			out<<nl;
			return;
		}
	}
