...
Z az(){
	...
	in>>a;
	// 30 operations for a 31 bit integer hmm OKOKOK one might think that simply traversing single bit or 1111 queries so like 00000010000000 or 000000000111111111111 or 11111111000000000 queries or something like that sliding from Right to Left might work frankly some type of If And Only If statement relating to these 1 bit Left to Right bitshifts in reverse and deducing the original by locating and pinpointing those precise indices at which the value shifted or whatever.
}
