...
/*
Consider the minimal element of the final after n-1 iterations without any trimming works but we still need to force distinctness at each step is like uh the dudes in the FFT would be like uh too large I think.
*/
	in>>a;
}
