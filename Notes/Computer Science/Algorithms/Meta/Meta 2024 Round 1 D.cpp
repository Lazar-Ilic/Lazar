...
Think what is relevant here is like a tracker for some digits can be 1 2 some are forced from 0 chains alternating including ? and some can actually be 1 2 3 4 5 6 7 8 9 and then still we need to out from there uh basically all those ?s convert and we still need to solve from there.
*/
	in>>as>>a;
}
