...
Z az(){
	...
	/* WLOG the ys are all single bit powers of 2. 
001
010
011
100
...
Say there are a 1s and b 0s then we can move to b+1 1s and a-1 0s or b-1 1s and a+1 0s uh think this is modulo 4 and uh the dude trivially. */
