...
OKOKOK so this is the 2nd time I have done this in recent months and it is probably bad form much sharper to simply out<<(al+bl-1)/bl<<nl; in terms of the underlying simple addition operations and 1 division operation call. Terrible brutal background construction noise here seems like all day every day now... hopefully soon I will be in a quiet 'burb not a city.
