...
Z az(){
	...
	/*
	It would look to me like first potentially we simplify the problem and without loss of generality operate through 1 inverse permutation isomorphism into the case where either the tree or the natural permutation is forced to be in order e.g. and then somehow we might just do like a bottoms up Tree Dynamic Program here.
	*/
