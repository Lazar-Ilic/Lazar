...
Analysis:
So if every single vertex can have uh 2D neighbours e.g. 2D<=N-1 is like a uh complete graph uh degeneracy edge case Input uh... 5 2 is like uh... overall density is uh like uh... 2 but like for a 4 is like 6/4 or whatever then yadda decreasing of course uh... simply forward and backward like D each direction works? Check a uh uh uh so 2 dudes connected iff Delta is like uh... D is like uh a complete graph on uh D+1 dudes induced is like uh... [D+1][D]/2 edges on uh... D+1 vertices is like uh... D/2 there uh...
*/
