...
Z az(){
	...
	// I think this problem task can be solved with an incredibly easy simple stack based approach that is to say that we simply stack up the Lefts and then process through in order like keeping a freq array variable dude and then process out.
	in>>as;
	VB avb;
	avb=VB(26,0);
	for(b=0;b<sz(as);b++){
