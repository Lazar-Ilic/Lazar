...
*/
	...
	in>>a;
	if(a<=999)out<<a<<nl;
	else if(a<=9999)out<<(a/10)*10<<nl;
	else if(a<=99999)out<<(a/100)*100<<nl;
	else if(a<=999999)out<<(a/1000)*1000<<nl;
	else if(a<=9999999)out<<(a/10000)*10000<<nl;
	else if(a<=99999999)out<<(a/100000)*100000<<nl;
	else if(a<=999999999)out<<(a/1000000)*1000000<<nl;
}
