...
Z az(){
	...
	/*
	I think basically we need to do a simple Digit Dynamic Programming based approach here. Uh something about tie breaks and where precisely we have some edge case derived around equal prefixes or equal suffixes or some such thing.

	OKOKOK fun fun fun little task should be an onsight it was a couple years back I did 1 of these little Segment Tree functional construction tasks to ACe in Q * log[n] time.
	*/
