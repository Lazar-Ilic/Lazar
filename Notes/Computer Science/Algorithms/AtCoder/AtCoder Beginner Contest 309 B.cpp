...
*/
	...
	bvs=avs;
	for(b=1;b<a;b++)bvs[0][b]=avs[0][b-1];
	for(b=1;b<a;b++)bvs[b][a-1]=avs[b-1][a-1];
	for(b=a-2;b>=0;b--)bvs[a-1][b]=avs[a-1][b+1];
	for(b=a-2;b>=0;b--)bvs[b][0]=avs[b+1][0];
	for(b=0;b<a;b++)out<<bvs[b]<<nl;
}
