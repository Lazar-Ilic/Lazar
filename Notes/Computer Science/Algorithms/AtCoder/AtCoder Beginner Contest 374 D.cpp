...
*/
	...
	avv=VV(a+1,V(4,0));
	for(b=1;b<=a;b++){
		in>>avv[b][0]>>avv[b][1]>>avv[b][2]>>avv[b][3];
	}
	av=V(0);
	for(b=0;b<a;b++)av.add(b);
	do{
		for(c=0;c<(1<<a);c++){
			dd=0;
			e=0;
			...
			for(d=1;d<=a;d++){
				if(c ba (1<<(d-1))){
					dd+=(sqrt((avv[av[d-1]+1][0]-e)*(avv[av[d-1]+1][0]-e)+(avv[av[d-1]+1][1]-f)*(avv[av[d-1]+1][1]-f)))/ad+(sqrt((avv[av[d-1]+1][2]-avv[av[d-1]+1][0])*(avv[av[d-1]+1][2]-avv[av[d-1]+1][0])+(avv[av[d-1]+1][3]-avv[av[d-1]+1][1])*(avv[av[d-1]+1][3]-avv[av[d-1]+1][1])))/bd;
					e=avv[av[d-1]+1][2];
					f=avv[av[d-1]+1][3];
				}
				else{
					dd+=(sqrt((avv[av[d-1]+1][2]-e)*(avv[av[d-1]+1][2]-e)+(avv[av[d-1]+1][3]-f)*(avv[av[d-1]+1][3]-f)))/ad+(sqrt((avv[av[d-1]+1][2]-avv[av[d-1]+1][0])*(avv[av[d-1]+1][2]-avv[av[d-1]+1][0])+(avv[av[d-1]+1][3]-avv[av[d-1]+1][1])*(avv[av[d-1]+1][3]-avv[av[d-1]+1][1])))/bd;
					e=avv[av[d-1]+1][0];
					f=avv[av[d-1]+1][1];
				}
			}
