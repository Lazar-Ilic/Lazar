...
*/
	...
	for(auto dude:as){
		if(dude=='(')ast.push(0);
		else if(dude=='[')ast.push(1);
		else if(dude=='<')ast.push(2);
		else if(dude==')' and !ast.empty() and ast.top()!=0)ast.push(3);
		else if(dude==']' and !ast.empty() and ast.top()!=1)ast.push(4);
		else if(dude=='>' and !ast.empty() and ast.top()!=2)ast.push(5);
