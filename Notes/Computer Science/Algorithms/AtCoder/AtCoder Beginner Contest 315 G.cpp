...
Analysis:
Seems like a trivial sort of canonical task too I was not sure if there was an easy sort of a search for some minimal 0 sum triplet like 3SUM type variants or whatever or if there was a canonical 3-Dimensional Pick's Theorem here.
*/
