...
Lousy reading comprehension here on my part demonstrated in the public written records otherwise I would have been Top 40 ab initio.

Test + Additional Input:


Analysis:
5 4 5 4 5 4 5 4 5 3 2 3 2 3 1

2 1 2

4 3 4 3 4 3 4 2 1 2

1 less of each dude and out end on a-2 a a-1 ugh.
*/

	in>>a;
	for(b=a;b>=1;b-=2)for(c=0;c<2*b-3;c++)out<<b-(c%2)<<" ";
	for(b=1;b<=a-2;b++)out<<b<<" ";
	out<<a<<" "<<a-1<<nl;
}
