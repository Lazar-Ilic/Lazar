...
Analysis:
Something about thinking about like some kind of Maximal Minimal stack simulation through from left to right at each step some isomorphism computable in O[1] and then some like final summation through of [Dude Choose 2] for an O[n] summation overall runtime.

Should be like list Right points of open chains to the Left of us and uh compress as needed uh or uh somehow have a stack and a couple of auxiliary multi pointer arrays with which to produce the desired.
*/
