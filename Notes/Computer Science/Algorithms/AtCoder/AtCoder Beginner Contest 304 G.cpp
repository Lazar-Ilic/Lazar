...
Might be a good starting point to tank here dunno about binary searching for the threshold value how easy or tricky it is to try and hit uh partition up the dudes to clear out the median of those values to uh clear out uh... dunno maybe think about minimising the wastage of 1s i.e. trying not to have 1s cancel in sorted uh order uh... kind of tricky not an onsight from for me to be sure here.
*/
