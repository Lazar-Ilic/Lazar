...
Z az(){
	...
	/*
	Totally possible that this is a trivial Dynamic Trees Programming task in the upsolve or there is some trivial insight proof of bounds in both directions and production for this task.
	*/
