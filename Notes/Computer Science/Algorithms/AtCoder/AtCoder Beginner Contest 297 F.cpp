...
/*
Combinatorics or Principle Of Inclusion Exclusion with Dynamic Programming and O[HW] partial summations might work fine here.

This task is half-interesting I mean I was thinking of doing a recursion based around the fact that the [a+1,b+1] case can recurse in to like the usual Bottoms Up Dynamic Programming based around uh like the [a+1,b] + [a,b+1] - [a,b] cases which are doubly overcounted or whatever... when like a O[HW/4] solution here is quite viable with fast precompute combinatorics in a C-style array call perhaps examine those runtimes more closely post facto in upsolving wrapups analysing fast ACcepted solutions.
*/
