...
Seems like a uh interesting task relating to the canonical strings processing algorithms which are so often taught in Competitive Programming and Algorithms courses.
*/
