...
/*
Seems like an extremely canonical Game Theory Nim variant task perhaps with the canonical Theorem or examination of low n case but think canonical Theorems here ought to work.
*/
