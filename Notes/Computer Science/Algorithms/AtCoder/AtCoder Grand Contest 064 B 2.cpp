...
Analysis:
Ugh not as simple as weighting the edges with a -1 value for matching the desired colour as we can not have... we need 0 to cost differently from 1 or 2 but a flow instance here is also tricky and I was tanked out on Task D.
*/
