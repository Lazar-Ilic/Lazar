...
const I p=715827883;// 998244353 1000000007
...
Z az(){
	...
	L al,bl,dl,fl,hl,il,jl,kl,ll,ml;
	S as,bs,cs,ds,es,fs,gs,hs,is,js,ks,ls,ms;
	V av,bv,dv,ev,fv,gv,hv,iv,jv,kv,lv,mv;
	P ap,bp,cp,dp,ep,fp,gp,hp,ip,jp,kp,lp,mp;
	VD avd,bvd,cvd,dvd,evd,fvd,gvd,hvd,ivd,jvd,kvd,lvd,mvd;
	VL avl,bvl,evl,fvl,gvl,hvl,ivl,jvl,kvl,lvl,mvl;
...
OKOKOKOKOKOK so we have a like cycle and a cycle strings and we can knock out the uh AR in a forward ARC or the CR in a forward CRA. So basically just ARCRARCRARC... the string ARC leaves 1 blank. ARCR leaves 0 blank. ARCRA leaves 1 blank. ARCRAR leaves 2 blank but also ARCARC leaves 2 blank... ARCRARC leaves 1 blank. And ARCRARCR leaves 0 blank. So it is like modulo 4 uh. If the dude is 1 or 3 modulo 4 it is if and only if there is 1 1 in the string. RCRAAA so we can uh... hit the uh... 001001 we can nail. We can nail uh 000011 as well. Can we get 101000? Well uh to hit that 0 would then require hitting 5 dudes. So if and only if there are more than 2 1s or 2 1s with distance with odd distance. For 9 we have ARCRARCRA OK... try the uh 10 case I guess... can we hit like 1010000000? What about 1000100000? _ARCRARCR Is it really the case that having 3 1s ensures success? 1010100000? _ARCRA
*/
