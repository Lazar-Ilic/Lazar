...
Analysis:
I ugh misread the task statement and tanked out way too long here not realising that the summation condition was in effect for the standard canonical Dynamic Program. Ugh OKOKOK so standard knapsack works here and so on and so on.
*/
