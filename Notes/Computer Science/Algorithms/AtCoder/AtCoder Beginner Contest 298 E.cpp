...
/*
Pretty simple here I think to compute the Probability underlying uh there may be faster in general with some of the usual AtCoder and Project Leonhard Euler style Combinatorics tricks here for a more general setting but here I think like a uh O[N^2*max[P,Q]] Dynamic Program will work out just fine Bottoms Up essentially from top cases umm.
*/
	...
	in>>a>>b>>c>>d>>e;
	avvl=VVL(a-b+1,VL(a-c+1,0)); // 1st Player Win P
	bvvl=VVL(a-b+1,VL(a-c+1,0)); // 2nd Player Win P
}
