...
Z az(){
	...
	// Generate the rows in a binary copying way or naively works and then just boom boom boom I want you in my room the rows.
	...
	out<<as<<nl<<bs<<nl<<cs<<nl<<ds<<nl<<cs<<nl;
	for(c=2;c<a;c++){
		out<<ds<<nl<<cs<<nl;
	}
}
