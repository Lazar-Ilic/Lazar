...
// dmkozyrev_thinks_slowly Dmitry Kozyrev
...
*/
	...
	const int NMAX=(1<<16); // Segmentation faults locally beyond this.
    alignas(128) static UI128 aui128[NMAX],bui128[NMAX],cui128[NMAX*2];
    for(i=0;i<NMAX;i++)aui128[i]=bui128[i]=1000000000;
    mult<NMAX>(aui128,bui128,cui128);
	out<<cui128[999]<<nl;
	//
}
