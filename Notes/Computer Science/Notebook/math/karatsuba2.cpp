...
*/
	...
	VUI128 avui128,bvui128,cvui128;
	avui128=VUI128(1000000,1000000000);
	bvui128=VUI128(1000000,1000000000);
	cvui128=karatsuba(avui128,bvui128);
	out<<cvui128[999999]<<nl;
	// This execution took around 252s to produce the correct answer which is interesting because it means that Karatsuba on underlying VUI128s of size around ~10^8 here could easily take around 1600* as long is a multi-year runtime for this particular Project Leonhard Euler task.
}
